...
public class StockAdapter extends RecyclerView.Adapter<StockAdapter.stockviewholder> {
    ...
    public StockAdapter(ArrayList<StockModel> stockModelList, StockListListner stockListListner, Context context) {
...
//            int number = Integer.parseInt();
                ...
                if (s.up_down_indicator.startsWith("-")) {
                    current_value.setTextColor(itemView.getResources().getColor(R.color.red));
                    down_arrow.setVisibility(View.VISIBLE);
                }

                if (s.up_down_indicator.startsWith(" ") || s.up_down_indicator.startsWith("+")) {
                    current_value.setTextColor(itemView.getResources().getColor(R.color.holo_green_dark));
